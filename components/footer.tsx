  ...
  return (
    <section className='bg-blue-1000 text-white relative w-full pb-24 sm:pb-32'>
      ...
      <section className='flex flex-col-reverse justify-center sm:flex-row items-center flex-wrap z-50 sm:justify-around w-10/12'>
        ...
        <section className='flex mt-10 sm:mt-40 flex-col'>
          <p>POUSADA LA VITA</p>
        ...
        <section>
          <section className='flex mt-14 sm:mt-40 gap-2 mb-6'>
        ...
        <button className="mt-14 py-2 px-6 rounded bg-yellow-1000 sm:mt-40">
          RESERVE JÁ
        </button>
      </section>
    </section>
