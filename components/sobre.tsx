...
import sm_review3 from '/public/static/elem/sm-review3.png'
import booking from '/public/static/elem/booking.png'

export default function Sobre() {
  return (
    <section className='mb-20'>
      <p className='text-xs mb-4 text-center border-black lg:text-xl'>
        POUSADA LA VITA
      </p>
      <h2 className='text-center mb-6 font-bold text-xl md:text-2xl lg:text-4xl'>
        O QUE DIZEM DE NÓS
      </h2>
      <hr className='w-[100px] mb-8 mx-auto h-[3px] md:w-[80px] lg:h-[4px] 2xl:mb-24 lg:w-[160px] 2xl:w-[200px] bg-yellow-1000' />
      <section className='flex flex-wrap gap-16 justify-center mx-auto w-11/12'>
        ...
        <section className='flex gap-6 w-80 flex-col'>
        ...
        <section className='flex gap-6 w-80 flex-col'>
          <p className='font-bold text-2xl text-center text-blue-1000'>
            Fernanda
          </p>
        ...
        <section className='flex gap-6 w-80 md:w-[450px] flex-col'>
          <section>
            <p className='font-bold text-2xl text-blue-1000'>
              Luisa
            </p>
            <section className='flex gap-4 items-center'>
              <Image className='' src={sm_review1} alt='sm-review1' />
              <p>
          ...
          <section>
            ...
            <section className='flex gap-4 items-center'>
              <Image className='' src={sm_review2} alt='sm-review2' />
              <p>
          ...
          <section>
            ...
            <section className='flex gap-4 items-center'>
              <Image className='' src={sm_review3} alt='sm-review3' />
              <p>
                Pousada nova com estrutura impecável. Limpeza e cortesia da equipe fantástica. Cama confortável, banheiro novo e limpo, ar condicionado bom, smarTV no quarto e piscina agradável
              </p>
            </section>
          </section>
        </section>
